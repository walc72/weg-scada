...
T.push('  <div v-for="(d,i) in drives" :key="d.name" style="background:white;border:1px solid #e0e0e0;border-radius:8px;margin-bottom:8px;overflow:hidden">');
...
T.push('    return {');
T.push('      drives: [], saving: false, info: "", infoOk: true, opened: {},');
T.push('      defaults: {');
T.push('        CFW900: {');
