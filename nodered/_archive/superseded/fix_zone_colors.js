...
// Update defaults to include colors
...
<div>
  ...
  <div v-if="authenticated">
    <v-tabs v-model="tab" color="primary" class="mb-4">
      <v-tab v-for="(dr, i) in drives" :key="i" :value="i"><v-icon start>mdi-lightning-bolt</v-icon>{{ dr.name }}</v-tab>
    </v-tabs>
        ...
        <div v-for="(cfg, key) in dr.config" :key="key" style="margin-bottom:10px">
          <v-card variant="outlined" rounded="lg">
            ...
            <v-card-text style="padding:8px 14px">
              <div style="display:grid;grid-template-columns:80px 1fr 80px 1fr 80px 1fr 80px;gap:6px;align-items:end">
                ...
                <div style="display:flex;align-items:end;gap:4px">
                  <input type="color" v-model="cfg.c1" style="width:32px;height:32px;border:none;cursor:pointer;border-radius:4px"/>
                ...
                <div></div>
                <div style="display:flex;align-items:end;gap:4px">
                  <input type="color" v-model="cfg.c2" style="width:32px;height:32px;border:none;cursor:pointer;border-radius:4px"/>
                ...
                <div></div>
                <div style="display:flex;align-items:end;gap:4px">
                  <input type="color" v-model="cfg.c3" style="width:32px;height:32px;border:none;cursor:pointer;border-radius:4px"/>
                  <span style="font-size:0.75em;color:#999">Zona 3</span>
                </div>
...
console.log('Updated config form with color pickers');
